...
An interactive pre-work page for the UPLB Data Science Guild applicants. Participants open the link days before the session, move through twenty-eight slides, walk the seven-stage life cycle map, pass a sequence check and a three-question self-check, read what the hands-on asks of them, and write one question to bring.
